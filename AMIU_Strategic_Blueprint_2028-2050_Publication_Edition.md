...
| **Appendix A — Cross-Reference to the Ten-Year Master Plan (AMIU-MP-001)** | **159** |
| **Appendix B — Master Plan Exhibit Checklist** | **160** |
| **Appendix C — Fixed Revenue Allocation Framework: Quick Reference** | **161** |
| **Appendix D — Programme Catalog Reference** | **162** |
| **Appendix E — Founding-Decade Risk Phases & the Pre-Incorporation Waqf-First Outreach Model** | **162** |
| **References** | **169** |
| **Index** | **171** |
...
![**Figure 1.** Ten-Year Enrollment Growth, Founding Decade (Adopted Growth Scenario)](assets/figures/fig02_enrollment_growth.png){width=92%}

*Source: AMIU-MP-001 §5.1, adopted Growth Scenario.*


![**Figure 2.** Ten-Year Gross Revenue Trajectory, Founding Decade (2028–2037)](assets/figures/fig03_revenue_growth.png){width=92%}
...
![**Figure 4.** The Seven-Tier Stackable Academic Ladder](assets/figures/fig07_seven_tier_ladder.png){width=92%}
...
![**Figure 5.** Student Journey Map: Inquiry to Alumni](assets/figures/fig09_student_journey.png){width=92%}
...
![**Figure 6.** Accreditation & International Expansion Roadmap, 2028–2047](assets/figures/fig10_accreditation_roadmap.png){width=92%}
...
![**Figure 7.** Waqf & Stakeholder Reserve: Distributed-Fund Allocation](assets/figures/fig05_waqf_distribution.png){width=92%}
...
![**Figure 8.** Revenue Allocation Framework — Fixed Annual Percentage of Gross Revenue](assets/figures/fig01_revenue_allocation.png){width=92%}
...
![**Figure 9.** Capital Architecture: The Tuition Firewall](assets/figures/fig08_capital_firewall.png){width=92%}
...
![**Figure 10.** Twenty-Year Illustrative Revenue Trajectory, 2028–2047](assets/figures/fig04_twenty_year_trajectory.png){width=92%}
...
| **Part VIII** (Risk, Compliance, Sustainability & the 20-Year Roadmap) | §14 (Risk Register), §5 (Financial Audit), §16 (Twenty-Year Horizon) | Extends the 14-risk register and financial model into a full risk/compliance operating system and 2050 roadmap |
...
## Appendix E — Founding-Decade Risk Phases & the Pre-Incorporation Waqf-First Outreach Model {.unnumbered}

Prepared in response to the Founding Council's *Reality-Based Financial Stress Test Directive* and *Waqf-First University Model* directive. This appendix does two things only: it reads the founding decade's already-adopted figures (AMIU-MP-001 §§5–7; Blueprint Sections 36 and 38) through an explicit year-by-year risk lens, and it extends the admissions timeline one phase earlier — a pre-incorporation Founding Registration campaign — consistent with the Waqf-First principle that access should precede revenue. It re-prices no tuition line, re-sizes no scholarship, and assumes no investment, donation, or grant not already carried in the adopted model. Two places below decline to follow the Founding Council's directive literally, and say so plainly, rather than quietly overriding an already-audited figure.

**E.1 — Year-by-Year Risk Phase Classification**

This phase reading introduces no new figures; it narrates the audited Growth-scenario table already adopted in AMIU-MP-001 §5.1/§5.8 (Blueprint Sections 1, 36, 38) through an explicit RAG lens.

| Year | Calendar | Phase | Status | Grounding in the Adopted Model |
|---|---|---|---|---|
| 1 | 2028 | Foundation & Struggle | RED | 347 students, $224,747 revenue — the smallest cohort and lowest-revenue year in the ten-year plan; heaviest proportional weight of one-time formation cost (~$1,015 Texas formation, Gambia-pipeline legal spend, Section 9) against the smallest revenue base |
| 2 | 2029 | Stabilisation & Survival | RED | Revenue nearly doubles ($451,397) but the institution is still pre-track-record: CPD accreditation pursued, Gambia registration begins (Section 37 Phase II); Sections 36/38 place risk-committee seating and external-audit cadence in this exact window |
| 3 | 2030 | Controlled Growth | AMBER | First year of the formation stack complete (Section 37 Phase I closes); PhD tier launches; still zero fee increase (Section 5.8 — no review assumed before Year 4) |
| 4–5 | 2031–2032 | Institutional Consolidation | AMBER→GREEN | First governance-approved fee review lands in Year 4 (Section 5.8); Liquidity Reserve crosses $1.29M cumulative by Year 5 (Section 5.7) |
| 6–10 | 2033–2037 | Expansion | GREEN | Post-Doctoral tier launches Year 6; reserves compound to $5.83M (Liquidity) and $3.33M (Waqf) by Year 10; Section 38's Decade Audit closes the founding decade with zero deficit years, audited |

The adopted model already treats Years 1–3 as the decade's most exposed on the pricing dimension specifically: no tuition increase is assumed in any of the three scenarios until Year 4 (AMIU-MP-001 §5.8). This phase table makes that fact visible in one place; it does not add risk that was not already priced in.

**E.2 — The No-Investment / No-Donor Scenario**

The Founding Council asked for a scenario in which no major investor, donor, grant, or government intervention arrives. AMIU-MP-001 already models exactly this as its *default*, not as a downside case:

- **Capital Firewall (§7):** the University's tuition-funded operations carry zero dependency on the Independent Commercial Engine's investor capital — the firewall exists precisely so that the Commercial Engine's success or failure never touches the academic model (Blueprint Section 39, Figure 9).
- **External Waqf Donor Contributions (§6.3):** the Master Plan assumes **$0** external donor giving in Years 1–3, and treats every dollar from Year 4 onward (illustrative only, $25,000 → $310,000 by Year 10) as additive and explicitly excluded from the core revenue waterfall in Section 5.
- **Financial Sustainability Framework (Blueprint Section 38):** because every cost category is a fixed percentage of *actual received* tuition revenue rather than a fixed obligation, the model is structurally deficit-proof under slower-than-planned growth — the Conservative scenario ($14.25M ten-year cumulative, versus $16.67M adopted) already models a materially slower path with zero deficit in any year.

Net: AMIU's "no-investment scenario" is not a hypothetical requiring new figures — it is the Conservative scenario already adopted in §5.8, run with the same zero-external-donor assumption that already governs Years 1–3 of every scenario. No revision to any adopted figure is required to answer the Founding Council's question; the honest answer is that the institution was already built this way.

**E.3 — Minimum Viable Year-1 Operating Model**

Not a downside projection — the actual adopted Year-1 budget (AMIU-MP-001 §5.4; Blueprint Appendix C), reconciled to the dollar:

| Line | Year 1 | % of Revenue |
|---|---|---|
| Total Active Enrollment | 347 students | — |
| Gross Revenue | $224,747 | 100% |
| Payroll (of which Faculty Honoraria $17,980, 40% of Payroll) | $44,949 | 20% |
| Marketing & Student Acquisition | $22,475 | 10% |
| Operating Expenses | $11,237 | 5% |
| LMS & Technology Infrastructure | $11,237 | 5% |
| Da'wah & Community Outreach | $11,237 | 5% |
| University-Side Liquidity Reserve | $78,661 | 35% |
| Waqf & Stakeholder Reserve | $44,951 | 20% |

No staffing line anywhere in this Blueprint (Sections 9–10, 15, 26, 36–38) is created ahead of the payroll capacity these figures generate; every FTE addition described elsewhere is explicitly phased to arrive only once its corresponding revenue year funds it.

**E.4 — Founding Registration & the Pre-Incorporation Outreach Window**

*Grounding note.* AMIU-MP-001 fixes incorporation at 6 December 2027 and academic operations commencing 1 January 2028 (Executive Summary; §9). A twelve-month campaign beginning January 2027 would run for most of a year before the University exists as a legal entity able to accept binding applications, hold funds, or issue admissions decisions. The Founding Council's two-phase design is therefore compressed below into what is actually available before incorporation, and is modeled explicitly as **Founding Committee** activity — not University action — until 6 December 2027.
...
*This index references Sections (1–40) and front-matter pages, not final print page numbers, consistent with this Blueprint's status as a living planning document subject to re-pagination on revision.*
...
**F**
Faculty Recruitment Strategy, Section 15 · Faculty Structure & ranks, Section 9 · Fast-Track policy, Sections 7, 12 · Financial Sustainability Framework, Section 38 · Firewall (see Capital Firewall) · Founding Registration & Pre-Incorporation Outreach, Appendix E
...
**K**
KPIs (see individual section headers — every section, Sections 1–40)
...
**R**
Research Strategy, Section 16 · Revenue Allocation Framework, Appendix C; Figure 8 · Revenue Diversification Strategy, Section 27 · Risk Management Framework & 14-risk register, Section 36 · Risk register (Years 11+ additions), Section 36 · Risk Phase Classification (Years 1–10, RAG), Appendix E
