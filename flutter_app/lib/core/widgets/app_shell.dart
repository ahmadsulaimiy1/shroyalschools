...
/// Root navigation shell: the 5-tab bottom navigation described in the design
/// system (Home / Counter / Adhkar / Statistics / Settings). About is reached
/// from Settings, not a top-level tab.
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: NavigationBar(
          ...
          destinations: [
            ...
            NavigationDestination(icon: const Icon(Icons.menu_book_outlined), selectedIcon: const Icon(Icons.menu_book), label: t('nav_adhkar')),
...
/// Lets any descendant screen (e.g. Home's "Start Counting" card, or Adhkar list
/// items) jump straight to the Counter tab without a full route push.
class AppShellScope extends InheritedWidget {
  const AppShellScope({super.key, required this.goToCounter, required super.child});
