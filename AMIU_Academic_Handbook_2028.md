...
| **Companion Volumes** | Constitution (AMIU-CON-001); Strategic Implementation Blueprint 2028&#8211;2050 (AMIU-SB-002); Institutional Governance Compendium (AMIU-IGC-004); Student Policies Handbook (AMIU-STUH-001); Operations Handbook (AMIU-OPSH-001) |
...
This Academic Handbook is certified by the AMIU Office of Institutional Planning as the authoritative and current statement of the nineteen academic policies it contains, effective as of the date shown on the Document Control page. It supersedes all prior drafts and non-final versions.
