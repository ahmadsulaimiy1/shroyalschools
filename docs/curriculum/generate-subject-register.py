...
w('> **مولَّد آليًّا** بواسطة `generate-subject-register.py` من `allocation-v11.json` — نفس المصدر الذي وُلِّد منه `CLASS-BOOK.md`، ومتوافق مع `00-LOCKED-DECISIONS.md`. **لا يُحرَّر باليد.**\n\n')
